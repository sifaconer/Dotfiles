...
local menu        = "fuzzel"  -- TODO: migrar a popup de quickshell
...
-- ██ SCREENSHOTS (grim + slurp + swappy, sin AUR) ═════════════
hl.bind("Print", hl.dsp.exec_cmd(
    'grim -g "$(slurp)" - | swappy -f -'
), { description = "Screenshot región + anotar" })
hl.bind(mainMod .. " + Print", hl.dsp.exec_cmd("grim - | wl-copy"),
    { description = "Screenshot pantalla completa al clipboard" })
hl.bind("CTRL + Print", hl.dsp.exec_cmd('grim -g "$(slurp)" - | wl-copy'),
    { description = "Screenshot región al clipboard" })
...
-- ██ LOCK / POWER ═════════════════════════════════════════════
hl.bind(mainMod .. " + CTRL + L",  hl.dsp.exec_cmd("hyprlock"), { description = "Lock" })
-- TODO: power menu en quickshell (reemplaza wlogout)
-- hl.bind(mainMod .. " + SHIFT + L", hl.dsp.exec_cmd("qs -c powermenu"), { description = "Power menu" })
