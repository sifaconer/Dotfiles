...
-- ║  La paleta actual es Catppuccin Mocha (dark neutral).       ║
-- ║  Cámbiala cuando diseñes tu "otro aire".                    ║
-- ╚══════════════════════════════════════════════════════════════╝

-- ── Paleta base (Catppuccin Mocha — personalizable) ──────────
Theme = {
    -- Base
    base      = "#1e1e2e",
    mantle    = "#181825",
    ...
    -- Fonts (de repos oficiales — sin AUR)
    font_mono = "JetBrains Mono",
    font_ui   = "Inter",
    font_size = 13,

    -- Cursor (default del sistema — elegir uno de repos después)
    cursor_theme = "",
    cursor_size  = 24,

    -- GTK (sin tema instalado — Adwaita dark default; elegir uno después)
    gtk_theme  = "",
